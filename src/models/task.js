			...
			<div data-task-id="${this.id}" class="flex flex-row justify-between gap-2 p-2">
                ...
                <div class="flex flex-row items-center gap-2">
                    <span class="flex flex-row items-center gap-2">
                        <span class="grow shrink-0 bg-rose-400 rounded w-4 h-4" style="background-color: ${list.color}"></span>
                        <span class="w-full line-clamp-1 shrink grow-0"> ${list.name} </span>
                    </span>
                    <button data-task-delete type="button">
