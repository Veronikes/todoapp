class TaskList {
    ...
    render() {
        return `
            <li data-list-id="${this.id}" data-screen="list-${this.id}" class="group data-[selected]:bg-neutral-200/50 rounded-md p-1 px-2">
                <a href="?screen=list-${this.id}" >   
                    <span class="w-full flex flex-row items-center justify-between">
                        ...
                        <div class="shrink-0 flex flex-row items-center gap-0.5">
                            <span class="bg-white border border-neutral-200 rounded w-6 h-6 flex items-center justify-center">3</span>
